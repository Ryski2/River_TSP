% Math 381 Project 1
% Variation 4: Guarantee we go through certain rivers.
clc; clear; close all
...
%river_data = table2array(river_data);
...
file = fopen('project1_var4.lp', 'wt');
...
% Ensure we go through each river in H
fprintf(file, 'true = 1;\n'); % Technical lpsolve stuff
for hh = H
    fprintf(file, 'y_%i = true;\n', hh);
end
